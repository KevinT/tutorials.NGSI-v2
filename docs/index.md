...
build upon concepts or enablers described in previous exercises to create a complex smart solution which is
...
It is recommended to start with reading the first **Core Context Management: The NGSI-v2 Interface** Chapter before
